...
<script type="text/javascript">
	...
	function searchShop(){
		...
		var value = obj.options[index].value; // 选中值
		 ...
		 window.location.href = "${pageContext.request.contextPath}/ProductshowServlet?category="+value;
	}
</script>
</HEAD>
<body>
			...
			<TBODY>
							...
							<tr>
								...
								<td align="right" bgColor="#ffffff" class="ta_01">
									...
									<button type="button" id="search" name="search"
										value="查询" class="button_view" onclick="searchShop()">
										查询</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
							...
							<c:forEach items="${product.list}" var="pro">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23">${pro.id}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%">${pro.name}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${pro.price}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${pro.pnum}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">
										${pro.category}</td>
									...
									<a href="${pageContext.request.contextPath}/DeleteByIdServlet?id=${pro.id}"> <img src="${pageContext.request.contextPath}/admin/images/i_del.gif"
						...
						<br>
							<!--  当前页数：${pageresult.currentPage} &nbsp;&nbsp;/ &nbsp;&nbsp;总页数：${pageresult.totalPage}-->
							<br>
