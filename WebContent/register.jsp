				...
				<tr>
					<td style="padding:30px">
						...
						<table width="70%" border="0" cellspacing="2" class="upline">
							<tr><td colspan="3"><font color="red">${register_error}</font></td></tr>
							<tr>
								<td style="text-align:right; width:20%">会员邮箱：</td>
								<td style="width:40%">
								<input type="text" class="textinput"
									name="email"  value="${user1.email}"/></td>
								<td><font color="#999999">请输入有效的邮箱地址</font></td>
							</tr>
							<tr>
								<td style="text-align:right">会员名：</td>
								<td>
									<input type="text" class="textinput" name="username" value="${user1.username}"/>
								</td>
							...
							<tr>
								...
								<td><input type="password" class="textinput"
									name="password"  value="${user1.password}"/></td>
								<td><font color="#999999">密码设置至少6位</font></td>
							</tr>
							<tr>
								<td style="text-align:right">重复密码：</td>
								<td><input type="password" class="textinput"
									name="repassword" ${user1.repassword}/></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="2"><input type="text" class="textinput"
									style="width:350px" name="telephone" value="${user1.telephone}"/></td>
							</tr>
							<tr>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<br>
								<font color="red">${checkcode_error}</font>
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
